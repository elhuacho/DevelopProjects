package escenario.transferencia;
...
import script.Transferencia;
//import web.Automation;


@RunWith(Parameterized.class)
public class Bpi_Transferencia extends ExecutionWrapper{
	
	public Bpi_Transferencia(String executionName, DataDictionary data){
	...
	public void script(){
		String output = "";
		try {
			Transferencia.transferirCuentasPropias();
			output = Transferencia.getResult();
		} catch (Exception e) {
